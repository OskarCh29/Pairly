...
| Ideas         | Shared date planner                        |
| Organization  | One dashboard instead of many applications |
...
Pairly is not intended to become:
